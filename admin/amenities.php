...
$page_title = "Event Amenities";
require_once '../core/core.php';
require_permission('manage_location');
if (isset($_POST['add'])){
    $name = strtolower($_POST['name']);
    $sql = $db->query("SELECT * FROM ".DB_PREFIX."amenities WHERE name='$name'");
    $num_row = $sql->rowCount();

    if ($num_row >= 1){
        set_flash("$name has already exist","danger");
    }else{
      $in = $db->query("INSERT INTO ".DB_PREFIX."amenities (name)VALUES('$name')");
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add Venue Amenity</h4>
            </div>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <a href="#"  data-toggle="modal" data-target="#modal-default" class="btn btn-primary btn-sm" style="margin-bottom: 20px;">
                Add Venue Amenity</a>
